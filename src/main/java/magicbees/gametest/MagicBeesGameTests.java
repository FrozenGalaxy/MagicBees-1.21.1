...
import magicbees.forestry.BeeSpeciesRuntimePatcher;
import magicbees.forestry.effect.SpawnMobBeeEffect;
import magicbees.forestry.effect.WorldTransformBeeEffect;
import magicbees.forestry.mutation.MoonPhaseMutationCondition;
import magicbees.forestry.mutation.RequiredBlockTagMutationCondition;
...
public final class MagicBeesGameTests {
    ...
    public static void mysteriousMagnetPreservesLegacyStateUpgradeAndAttraction(GameTestHelper helper) {
        ...
        double expectedRange = magicbees.config.MagicBeesConfig.COMMON.magnetBaseRange.get()
                + 6 * magicbees.config.MagicBeesConfig.COMMON.magnetLevelMultiplier.get();
    ...
    public static void wildHiveDefinitionsMatchLegacyLedger(GameTestHelper helper) {
        ...
        for (var block : List.of(Blocks.STONE, Blocks.GRANITE, Blocks.POLISHED_GRANITE, Blocks.DIORITE,
            ...
            helper.assertTrue(magicbees.forestry.hive.MagicHivePlacements.isLegacyStone(block.defaultBlockState()),
                    "Lost flattened 1.12 Blocks.STONE variant " + block);
        }
        helper.assertTrue(!magicbees.forestry.hive.MagicHivePlacements.isLegacyStone(Blocks.DEEPSLATE.defaultBlockState()),
                "Deepslate did not exist in the 1.12 Blocks.STONE metadata family");
        helper.assertTrue(!magicbees.forestry.hive.MagicHivePlacements.isLegacyStone(Blocks.TUFF.defaultBlockState()),
        ...
        for (var block : List.of(Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.GRASS_BLOCK)) {
            helper.assertTrue(magicbees.forestry.hive.MagicHivePlacements.isLegacyDirtGround(block.defaultBlockState()),
                    "Lost flattened 1.12 dirt/grass hive ground " + block);
        }
        helper.assertTrue(!magicbees.forestry.hive.MagicHivePlacements.isLegacyDirtGround(Blocks.ROOTED_DIRT.defaultBlockState()),
        ...
        for (var block : List.of(Blocks.SAND, Blocks.RED_SAND, Blocks.SANDSTONE, Blocks.CHISELED_SANDSTONE,
            ...
            helper.assertTrue(magicbees.forestry.hive.MagicHivePlacements.isLegacySandGround(block.defaultBlockState()),
                    "Lost flattened 1.12 sand/sandstone hive ground " + block);
        }
        helper.assertTrue(!magicbees.forestry.hive.MagicHivePlacements.isLegacySandGround(Blocks.RED_SANDSTONE.defaultBlockState()),
