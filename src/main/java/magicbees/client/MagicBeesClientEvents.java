...
import magicbees.client.renderer.EffectJarRenderer;
import magicbees.client.screen.EffectJarScreen;
...
public final class MagicBeesClientEvents {
    ...
    public static void modifyBakedModels(ModelEvent.ModifyBakingResult event) {
        if (!magicbees.config.MagicBeesConfig.CLIENT.oldJarModel.get()) return;
